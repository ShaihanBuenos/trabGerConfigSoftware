    ...
    public void VerifyUser() throws ParseException {
        ...
        case 1:
            ...
            case 2:
                ...
                Administrador adm1 = new Administrador("Paulo", "Soarez");
                Paciente pac1 = new Paciente("Joana", "Silva", "JSilva@gmail.com");
                Autorizacoes aut1 = new Autorizacoes(new Date(2021, Calendar.MARCH, 10), medico1, pac1,
                        new Exame(Exames.Tomografia, true, new Date(2021, Calendar.MARCH, 10)));
                Autorizacoes aut2 = new Autorizacoes(new Date(2021, Calendar.MARCH, 9), medico1, pac1,
                        new Exame(Exames.Ecografia, false, new Date()));
                Autorizacoes aut3 = new Autorizacoes(new Date(2021, Calendar.MARCH, 11), medico1, pac1,
                        new Exame(Exames.Mamografia, false, new Date(2021, Calendar.MARCH, 11)));
                Autorizacoes aut4 = new Autorizacoes(new Date(2021, Calendar.MARCH, 12), medico1, pac1,
                        new Exame(Exames.Mamografia, false, new Date(2021, Calendar.MARCH, 11)));
                Autorizacoes aut5 = new Autorizacoes(new Date(2021, Calendar.MARCH, 8), medico1, pac1,
                        new Exame(Exames.Mamografia, false, new Date(2021, Calendar.MARCH, 11)));
                break;
